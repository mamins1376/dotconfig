...
c.NotebookApp.notebook_dir = 'document/jupyter'
...
#  Choices: any of ['sha3_384', 'sha256', 'sha512', 'sha3_512', 'md5', 'blake2b', 'sha3_256', 'sha384', 'sha1', 'sha3_224', 'sha224', 'blake2s']
#  Default: 'sha256'
